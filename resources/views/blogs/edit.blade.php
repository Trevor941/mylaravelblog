    ...
    <h3>Create A Blog</h3>
        ...
        <form action="{{route('blogs.update', $blog->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control tinymce-editor" name="body" rows="5">{{$blog->body}}</textarea>
            </div>
            <div class="form-group">
                @error('blog_image')
                 <div class="alert alert-danger">{{$message}}</div>
            ...
            <button type="submit" class="btn btn-secondary form-control">Update Blog</button>
        </form>
        </div>
